(() => {
  ...
  const initializeTimeline = () => {
    const timeline = document.querySelector("[data-candomble-timeline]");
    const controls = document.querySelector("[data-candomble-timeline-controls]");
  ...
  const initializeAccordions = () => {
    document.querySelectorAll("[data-candomble-myths], [data-candomble-faq]").forEach((group) => {
  ...
  const initializeMobileToc = () => {
    const toc = document.querySelector(".candomble-toc details");
    if (!toc) return;
