(() => {
  'use strict';
  const navLinks = [...document.querySelectorAll('.santeria-sidenav a[href^="#"]')];
  ...
  const filterBox = document.querySelector('.santeria-source-filters');
  const references = [...document.querySelectorAll('.santeria-reference-list details[data-source-type]')];
