(() => {
  ...
  const initializeTimeline = () => {
    const timeline = document.querySelector("[data-theosophy-timeline]");
    const controls = document.querySelector("[data-theosophy-timeline-controls]");
  ...
  const initializeAccordion = () => {
    document.querySelectorAll("[data-theosophy-accordion]").forEach((group) => {
