(() => {
  ...
  const navLinks = [...document.querySelectorAll('.maia-sidenav a[href^="#"]')];
  ...
  const filterBox = document.querySelector('.maia-source-filters');
  const references = [...document.querySelectorAll('.maia-reference-list details[data-source-type]')];
