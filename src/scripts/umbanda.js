(() => {
  ...
  const initializeTimeline = () => {
    const timeline = document.querySelector("[data-umbanda-timeline]");
    const controls = document.querySelector("[data-umbanda-timeline-controls]");
  ...
  const initializeAccordions = () => {
    document.querySelectorAll("[data-umbanda-accordion], [data-umbanda-faq]").forEach((group) => {
