(() => {
  ...
  const initializeTimeline = () => {
    const timeline = document.querySelector("[data-batuque-timeline]");
    const controls = document.querySelector("[data-batuque-timeline-controls]");
  ...
  const initializeAccordions = () => {
    document.querySelectorAll("[data-batuque-myths], [data-batuque-faq]").forEach((group) => {
  ...
  const initializeMobileToc = () => {
    const toc = document.querySelector(".batuque-toc details");
    if (!toc) return;
